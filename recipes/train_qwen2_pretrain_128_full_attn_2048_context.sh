...
python torchprime/torch_xla_models/train.py \
    run_name=reshape_context_2048_full_attn_small_batch_lr_1e-4 \
    ...
    checkpoint_save_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen25_coder_1b_flex_v2_context_2048_full_attn_bsz_512_lr_1e-4/ \
    save_steps=10000 \
    logging_steps=1 \
    ici_mesh.fsdp=32 \
    ici_mesh.tensor=2 \
