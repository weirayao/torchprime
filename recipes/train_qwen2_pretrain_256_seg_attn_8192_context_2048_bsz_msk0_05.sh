...
python torchprime/torch_xla_models/train.py \
    ...
    max_steps=55000 \
    checkpoint_load_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen25_coder_1b_flex_v2_mask0_05_256_context_8192_seg_attn_bsz_2048_lr_3e-4/ \
    checkpoint_load_step=30000 \
    resume_from_checkpoint=true \
    checkpoint_save_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen25_coder_1b_flex_v2_mask0_05_256_context_8192_seg_attn_bsz_2048_lr_3e-4/ \
    save_steps=2500 \
    logging_steps=1 \
    ici_mesh.fsdp=64 \
    ici_mesh.tensor=2 \
