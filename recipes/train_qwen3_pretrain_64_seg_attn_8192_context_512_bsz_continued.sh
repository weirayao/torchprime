...
python torchprime/torch_xla_models/train.py \
    run_name=qwen3_tpu_64_context_8192_full_attn_small_batch_lr_2e-4_continued \
    ...
    checkpoint_load_step=49500 \
    resume_from_checkpoint=false \
    checkpoint_save_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen3_1b_flex_v2_tpu_64_context_8192_full_attn_small_batch_lr_2e-4_continued \
    save_steps=5000 \
    logging_steps=1 \
    ici_mesh.fsdp=16 \
    ici_mesh.tensor=2 \
