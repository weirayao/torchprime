...
python torchprime/torch_xla_models/train.py \
    run_name=tpu_128_context_8192_segment_attn_small_batch_lr_2e-4_continued \
    ...
    checkpoint_save_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen25_coder_1b_flex_v2_tpu_64_context_8192_segment_attn_small_batch_lr_2e-4_continued \
    save_steps=5000 \
    logging_steps=1 \
    ici_mesh.fsdp=32 \
    ici_mesh.tensor=2 \
