...
python torchprime/torch_xla_models/train.py \
    run_name=rerun_sft_from_midtrain_qwen25_coder_1b_opc_stage1_context_1024_bsz_2048_lr_1e-5 \
    training_mode=sft \
    ...
    checkpoint_save_dir=gs://sfr-text-diffusion-model-research/checkpoints/sft_from_midtrain_qwen25_coder_1b_opc_stage1_context_1024_bsz_2048_lr_1e-5_rerun/ \
    save_steps=450 \
    logging_steps=1 \
    ici_mesh.fsdp=64 \
    ici_mesh.tensor=2 \
