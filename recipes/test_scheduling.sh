...
python torchprime/torch_xla_models/train.py \
    ...
    optimizer.learning_rate=3.3e-4 \
    lr_scheduler.warmup_steps=0 \
    global_batch_size=8192 \
    max_steps=20000 \
    checkpoint_load_dir=gs://sfr-text-diffusion-model-research/checkpoints/pretrain_qwen2_5_Coder_1_5b/ \
    checkpoint_load_step=3500 \
