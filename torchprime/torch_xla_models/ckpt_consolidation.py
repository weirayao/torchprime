...
class Trainer:
  ...
  def consolidate_checkpoints(self):
    if self.config.resume_from_checkpoint is None:
      raise ValueError("Cannot consolidate checkpoints if resume_from_checkpoint is not provided")
...
def main(config: DictConfig):  
  ...
  with jax_env_context():
    trainer.consolidate_checkpoints()
