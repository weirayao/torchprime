...
"""Verbatim copy of orignal Llama4 model from HF:
https://github.com/huggingface/transformers/blob/main/src/transformers/models/llama4/modeling_llama4.py

For reference only, not meant to be executed directly.
"""
...
class Llama4TextModel(Llama4PreTrainedModel):
  ...
  def _update_causal_mask(
    ...
    if (
      self.config._attn_implementation == "sdpa" and chunked_attention_mask is not None
    ):
